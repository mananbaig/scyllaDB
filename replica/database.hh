...
private:
    ...
    future<> do_apply_many(const frozen_mutation_vector&, db::timeout_clock::time_point timeout);
...
public:
    ...
    future<> apply(const frozen_mutation_vector&, db::timeout_clock::time_point timeout);
