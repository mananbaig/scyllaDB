...
public:
    ...
    using created_keyspace_per_shard = std::vector<foreign_ptr<std::unique_ptr<keyspace>>>;
    using keyspace_change_per_shard = std::vector<foreign_ptr<std::unique_ptr<keyspace_change>>>;
